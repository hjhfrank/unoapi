    ...
    methods: {
        btn1(nn) {
            ...
            this.$nextTick(() => {
                ...
                n2 = n1 * 40;
                if ((nn == 0) | (nn == 99)) {
                    this.$refs.wt1.scrollTo(0, n2);
                }
                if (nn == -1) {
                    if (this.npt < this.nwt1) {
                        this.nwt1 = this.npt;
                        this.nwt2 = this.nwt1 + 11;
                        this.$refs.wt1.scrollTo(0, this.nwt1 * 40);
                    }
                }
                if (nn == 1) {
                    if (this.npt > this.nwt2) {
                        this.nwt1 = this.npt - 11;
                        this.nwt2 = this.npt;
                        this.$refs.wt1.scrollTo(0, this.nwt1 * 40);
                    }
                }
